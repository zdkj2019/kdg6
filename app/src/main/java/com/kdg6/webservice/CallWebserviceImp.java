...
public class CallWebserviceImp {
	...
	private String timestamp = new DateUtil()
			.toDataString("yyyy-MM-dd HH:mm:ss.S");
	private int seq = new DateUtil().toInt();
	...
	public synchronized JSONObject getWebServerInfo(String astrsql, String astrparms,
		...
		param.put("in0", DateUtil.encode(astrparms));
		param.put("in1", DateUtil.encode(astrsql));
	...
	public JSONObject getWebServerInfo(String astrczbs, String astrparms,
		...
		HashMap<String, Object> param = new HashMap<String, Object>();
		param.put("in0", DateUtil.encode(astrczbs));
		param.put("in1", DateUtil.encode(astrparms));
		param.put("in2", DateUtil.encode(astrczry));
		String jsonData = (String) new WsClient().loginTest(param, methodName, "ZD", mContext);
		jsonData = delInitTime(jsonData);
		JSONObject jsonObject = new JSONObject(jsonData);
		return jsonObject;
	...
	public JSONObject getWebServerInfo(String astrczbs, String astrparms,
		...
		param.put("in1", DateUtil.encode(astrparms));
		param.put("in2", DateUtil.encode(astrczry));
		param.put("in3", DateUtil.encode(astrpk));
		String jsonData = (String) new WsClient().loginTest(param, methodName, "ZD", mContext);
		jsonData = delInitTime(jsonData);
		JSONObject jsonObject = new JSONObject(jsonData);
		return jsonObject;
	...
	public JSONObject getWebServerInfo2_pic(String astrczbs,
		...
		param.put("in0", DateUtil.encode(astrczbs));
		param.put("in1", DateUtil.encode(astrparms));
		param.put("in3", DateUtil.encode(astrczry));
		param.put("in2", DateUtil.encode(astrpk));
		param.put("in4", data1);
