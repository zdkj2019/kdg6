 ...
 *
 */
public class GzzskList extends FrameActivity {
	...
	private String[] from;
	private int[] to;
	private String name = "",zlbm="",xlmc="",flag,currsjbm="",zsdbm="";
	...
	protected void initVariable() {
		...
		xlmc = getIntent().getStringExtra("xlmc");
	}
	...
	protected void initListeners() {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 0) {
					zsdbm = data.get(position).get("zsdbm");
